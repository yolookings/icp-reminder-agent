...
import { idlFactory } from './reminder-frontend.did.js';
export { idlFactory } from './reminder-frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REMINDER_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./reminder-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the reminder-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./reminder-frontend.did.js")._SERVICE>}
 */
export const reminder_frontend = createActor(canisterId);
